...
class HighLevelPartialPlan:
    def __init__(self,  agent_origin,
                        agent_pre_box,
                        box_pos_origin=None,
                        box_pos_end=None,
                        agent_post_box=None,
        ...
        self.agent_pre_box = agent_pre_box
        self.box_pos_origin = box_pos_origin
        self.box_pos_end = box_pos_end
        self.agent_post_box = agent_post_box
        self.agent_end = agent_end

        if self.box_pos_origin is None:
            self.agent_end = self.agent_pre_box
            self.agent_pre_box = None
...
class ParallelPlanner:
    ...
    def move_box_to_storage(self, pos):
        ...
        agent_box_pos = self.get_node_before_position(agent_node_finished, box_final_pos)
        agent_final = agent_node_finished.pos
        self.state.set_agent_position(box_final_pos, agent_final)

        self.current_plan.append(HighLevelPartialPlan(agent_origin, agent_pre_box, pos,
                                                      box_final_pos,agent_box_pos, agent_final))
    ...
    def move_agent_to_storage(self, pos):
        ...
        self.current_plan.append(HighLevelPartialPlan(pos, final_pos))
